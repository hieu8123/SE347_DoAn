...
import { actionGetAllOrdersOfAdmin } from "../../redux/actions/order";
import Loader from "../Layout/Loader";
import { actionGetAllSellers } from "../../redux/actions/seller";
...
const AdminDashboardMain = () => {
  ...
  useEffect(() => {
    dispatch(actionGetAllOrdersOfAdmin());
    dispatch(actionGetAllSellers());
  }, [dispatch]);
