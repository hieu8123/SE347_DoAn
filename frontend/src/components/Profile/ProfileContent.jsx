...
import {
  actionDeleteUserAddress,
  actionLoadUser,
  actionUpdateUserAddress,
  actionUpdateUserInformation,
} from "../../redux/actions/user";
import { Country, State } from "country-state-city";
import { useEffect } from "react";
import { toast } from "react-toastify";
import axios from "axios";
import { actionGetAllOrdersOfUser } from "../../redux/actions/order";
...
const ProfileContent = ({ active }) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    dispatch(actionUpdateUserInformation(name, email, phoneNumber, password));
  };
...
const Address = () => {
  ...
  const handleDelete = (item) => {
    const id = item._id;
    dispatch(actionDeleteUserAddress(id));
  };
