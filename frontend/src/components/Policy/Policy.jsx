        ...
        <div>
          ...
          <div>
            ...
            <p>
              ...
              dịch vụ, Shoppao đảm bảo quyền lợi của Người mua bằng cách cho
              phép gửi yêu cầu hoàn trả sản phẩm và/hoặc hoàn tiền trước khi hết
              hạn. Thời hạn Shoppao Đảm Bảo đã được quy định trong Điều khoản
              Dịch vụ. Shoppao Đảm bảo thực hiện bởi Shoppao, theo yêu cầu của
              Người dùng, để hỗ trợ Người dùng trong việc giải quyết các xung
              đột có thể phát sinh trong quá trình giao dịch. Người dùng có thể
              liên hệ với nhau để thỏa thuận về việc giải quyết tranh chấp của
              họ hoặc báo cáo lên Shoppao hoặc cơ quan nhà nước có thẩm quyền để
              được hỗ trợ trong việc giải quyết bất kỳ tranh chấp xảy ra trước,
              trong hoặc sau khi sử dụng Shoppao Đảm bảo.
            </p>
            ...
            <ol>
              ...
              <li>
                ...
                nhiên Shoppao sẽ cần Người bán xác nhận lại những thỏa thuận
                này).
              </li>
            </ol>
            <p>
              Người mua có thể gửi yêu cầu trả hàng/hoàn tiền trong vòng 07
              (bảy) ngày (đối với các sản phẩm thuộc Shoppao) và 03 (ba) ngày
              (đối với các sản phẩm không thuộc Shoppao) kể từ lúc đơn hàng được
              cập nhật giao hàng thành công. Riêng đối với các sản phẩm thực
              phẩm tươi sống và đông lạnh (trừ trường hợp chưa nhận được hàng),
              Người mua cần gửi yêu cầu trả hàng/hoàn tiền trong vòng 24 giờ kể
              từ lúc đơn hàng được cập nhật giao hàng thành công.
            </p>
            ...
            <p>
              ...
              mua, Shoppao sẽ xem xét và quyết định cho Người mua được trả
              hàng/hoàn tiền, đồng thời thông báo (i) về yêu cầu trả hàng/hoàn
              tiền của Người mua hoặc (ii) quyết định xử lý yêu cầu Trả
              hàng/hoàn tiền của Shoppao cho Người bán trên Ứng dụng và/hoặc thư
              ...
              Shoppao trong từng thời điểm) kể từ ngày nhận được thông báo của
              Shoppao nếu không đồng ý với quyết định hoàn tiền của Shoppao hoặc
              ...
              trong quá trình hàng được hoàn trả. Sau thời gian này mà Shoppao
              không nhận được bất cứ phản hồi nào từ Người bán, Shoppao hiểu
              rằng Người bán hoàn toàn đồng ý với quyết định xử lý của Shoppao
              và không có khiếu nại. Việc hoàn tiền cho người mua có thể được
              Shoppao cân nhắc thực hiện mà không cần Người mua phải hoàn trả
              hàng cho Người bán.
            </p>
            ...
            <p>
              ...
              chuyển cho việc trả hàng. Shoppao sẽ hỗ trợ hoàn lại một phần phí
              trả hàng dưới hình thức Shoppao Xu theo chính sách của Shoppao khi
            ...
            <p>
              Shoppao khuyến khích Người mua chủ động liên hệ với Người bán để
              thương lượng và giải quyết với nhau thông qua các kênh liên lạc
              được cung cấp trên hệ thống Shoppao khi có bất cứ vấn đề nào phát
      ...
      content: (
        <div>
          ...
          <p>
            ...
            khách hàng Shoppao để được hỗ trợ
          </p>
          ...
          <p>
            ...
            bộ phận Chăm sóc khách hàng Shoppao để được hỗ trợ:
          </p>
          <p>1. Hotline: 19001221</p>
          <p>
            2. Email:
            https://help.Shoppao.vn/portal/webform/9e0e87184cf14246aabe6af0d78b2aa9
          </p>
          <p className="font-bold">4. THỜI GIAN BẢO HÀNH:</p>
          <p className="font-bold">a. Bảo hành tại nhà sản xuất</p>
          <p>
            Sản phẩm cung cấp được đảm bảo hàng chính hãng nên Shoppao khuyến
          ...
          <p className="font-bold">b. Bảo hành thông qua Shoppao</p>
          <p>
            Trường hợp quý khách gửi sản phẩm bảo hành về Shoppao, chúng tôi sẽ
            gửi thông báo xác nhận đến quý khách khi Shoppao nhận được sản phẩm
          </p>
          <p>
            Thời gian bảo hành sản phẩm của quý khách dự kiến từ 20 ngày đến 45
            ngày làm việc tính từ lúc Shoppao nhận được sản phẩm, tùy thuộc vào
            linh kiện cần thay thế của Hãng và Shoppao sẽ thông báo chi tiết đến
      ...
      content: (
        <div>
          ...
          <div>
            ...
            <p>
              1.1. Các loại hàng hóa không hỗ trợ vận chuyển trên Shoppao bao
              gồm nhưng không giới hạn các loại hàng hóa sau:
            </p>
            <ol>
              <li>
                a. Hàng hóa thuộc danh mục cấm giao dịch trên Shoppao. Xem chi
                tiết tại TẠI ĐÂY;
              </li>
              <li>
              ...
              <li>
                ...
                giá của Shoppao, mã giảm giá của Người Bán, xu và phí vận
                chuyển);
              </li>
              <li>
              ...
              <li>
                ...
                và khuyến cáo về vận chuyển của Shoppao được nêu ra trong Chính
                Sách Vận Chuyển;
              </li>
              <li>
                g. Người dùng vi phạm các Tiêu chuẩn cộng đồng của Shoppao. Tham
              ...
              <li>
                ...
                của Shoppao trong từng thời điểm.
              </li>
            </ol>
            <p>
              1.2. Miễn trừ trách nhiệm cho Shoppao và các bên có liên quan: Với
              các mặt hàng thuộc danh mục Shoppao không hỗ trợ vận chuyển kể
              trên, Shoppao cũng như các bên có liên quan trong quá trình vận
              chuyển hàng hóa sẽ không chịu trách nhiệm nếu hàng hóa bị thu giữ,
              tiêu hủy hay hư hỏng trong quá trình vận chuyển. Người Bán chịu
              hoàn toàn trách nhiệm trước Shoppao và pháp luật (nếu có) khi gửi
              hàng vi phạm Chính Sách Vận Chuyển của Shoppao và pháp luật Việt
              Nam.
            </p>
            <p>
              1.3. Trong trường hợp Người Bán cố tình vi phạm các quy định về
              hàng hóa không hỗ trợ vận chuyển trên Sàn Shoppao, Người Bán phải
              bồi thường đầy đủ và toàn bộ các thiệt hại phát sinh mà Shoppao
            ...
            <p>
              ...
              gồm cả nghĩa vụ bồi thường mọi thiệt hại mà Shoppao và/hoặc các
        ...
        <div className="w-1/5 policy_row1">
          <ul className="space-y-4 policy_list ">
            {policies.map((policy, index) => (
              <div className="flex border-b justify-between pl-10 policy_body " key={index}>
                <li
                  key={policy.id}
